                ...
                <>
                    <div className="relative pt-36 ml-auto">
                        <div className="lg:w-2/3 text-center mx-auto">
                            <h1 className="text-gray-900 dark:text-white font-bold text-5xl md:text-6xl xl:text-7xl">Administration des configurations <span className="text-primary dark:text-white">pour les équipements CISCO MERAKI</span></h1>
